...
const handler = async () => {
    try {
        const BRAINTREE_GRAPHQL_API = "https://payments.sandbox.braintree-api.com/graphql";
        const BRAINTREE_PUBLIC_KEY = "PUBLIC_KEY";
        const BRAINTREE_PRIVATE_KEY = "PRIVATE_KEY";
        const authToken = Buffer.from(`${BRAINTREE_PUBLIC_KEY}:${BRAINTREE_PRIVATE_KEY}`).toString("base64");
